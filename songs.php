...
<html>
  <head>
    ...
    <script>
      function cambia_de_pagina(id){
          ...
          location.href="http://81.169.234.32/danih/projectMusicCliente/modifySongs.php"
      }
    </script>
  ...
  <body>
    ...
    <div class="input-group center-block" style=" width: 250px" >
         ...
         <button style="margin-top: 3px; margin-left: 80px"   type="submit" class="btn btn-primary mb-2 crear">Add</button>

         <button  id='listaCancionesUpdate' style="margin-top: 3px" class="btn btn-ghost btn-primary btn-ghost-bordered center-block">Songs List</button>
